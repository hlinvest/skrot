...
ALLOWED_HOSTS = ['www.skrotindex.dk', 'skrotindex.dk']
MANAGERS = ADMINS
...
DATABASES = {
    'default': {
        ...
        'NAME': 'skrotindex',                      # Or path to database file if using sqlite3.
...
MEDIA_ROOT = '/home/hlinvest/webapps/skrotindex_media/'
...
STATIC_ROOT = '/home/hlinvest/webapps/skrotindex_static/'

# URL prefix for static files.
# Example: "http://example.com/static/", "http://static.example.com/"
STATIC_URL = 'http://skrotindex.dk/static/'

# Additional locations of static files
STATICFILES_DIRS = (
          '/home/hlinvest/webapps/skrotindex/skrotIndex/static/',
)
...
SECRET_KEY = '1xcnl+=t&tdf0%9##b9@wbr92p#fjk(x2=)1=zjlva@lz(v2rt'
...
ROOT_URLCONF = 'skrotIndex.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'skrotIndex.wsgi.application'

TEMPLATE_DIRS = (
  '/home/hlinvest/webapps/skrotindex/skrotIndex/templates'
)
